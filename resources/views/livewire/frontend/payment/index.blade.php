        ...
        <div class="container mb-lg-5">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-3 text-center">
                    <div class="card h-100 border-0 rounded-lg shadow">
                        <div class="card-body">
                            ...
                            <p></p>
                            <h6 class="font-weight-bold">0289196729</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mt-3 text-center">
                    <div class="card h-100 border-0 rounded-lg shadow">
                        <div class="card-body">
                            <img src="{{ asset('images/payment-ovo.png') }}" style="width: 150px">
                            <hr>
                            <h6>ROBBY NOVIANTO</h6>
                            <p></p>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" wire:ignore>
                                    ...
                                    <select class="form-control select-bank-to" wire:model="bank_transfer_to" name="bank_transfer_to" required>
                                        ...
                                        <option value="BNI - 0289196729 - AN. ROBBY NOVIANTO"> BNI - 0289196729 |
                                            AN. ROBBY NOVIANTO</option>
