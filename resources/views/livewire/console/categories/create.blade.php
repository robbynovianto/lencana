                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="text-center">
                                <img src="{{ $image->temporaryUrl() }}" alt="" style="height: 300px;width:300px;object-fit:cover"
                                    class="img-thumbnail">
                                    <p>PREVIEW</p>
                            </div>
                            @else
                                <div class="text-center">
                                <img src="{{ asset('images/image.png') }}" alt="" style="height: 300px;width:300px;object-fit:cover"
                                    class="img-thumbnail">
                                    <p>PREVIEW</p>
                                </div>
                            @endif
