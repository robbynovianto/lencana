...
<body style="background-color: #e2e8f0;">
    ...
    <!-- Dashboard -->
    <a class="navbar-brand font-weight-bold" href="{{ route('console.dashboard.index') }}"><i class="fa fa-diamond" aria-hidden="true"></i> R-DUA STORE</a>
    ...
    <div class="jumbotron rounded-0" style="background-color: #e2e8f0;padding-bottom:8rem">
        <div class="container">
        </div>
    </div>
